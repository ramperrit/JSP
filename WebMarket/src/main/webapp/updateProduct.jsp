		...
		<div class="col-md-7">
			<form name="newProduct" action="./processUpdateProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input type="radio" name="unitsInStock" value="New">신규 제품
						<input type="radio" name="unitsInStock" value="Old">중고 제품
						<input type="radio" name="unitsInStock" value="Refurbished">재생 제품
					</div>
				</div>
				<div class="form-group row">
