                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                ...
                                <li class="nav-item"><a class="nav-link" href="/Member/login.jsp">Login</a></li>
                                <li class="nav-item"><a class="nav-link" href="/Member/signUp.jsp">SignUp</a></li>
                                ...
                                <c:otherwise>
                                <li class="nav-item active"><a class="nav-link" href="/main.jsp">Home</a></li>
                                <li class="nav-item"><a class="nav-link" href="/Member/logout.jsp">Logout</a></li>
